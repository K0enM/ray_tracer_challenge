...
impl Camera {
  pub fn new(hsize: usize, vsize: usize, fov: f64) -> Self {
    ...
    Self { hsize, vsize, fov, transform: Matrix::identity(), half_width, half_height, pixel_size }
  }
  ...
  pub fn render(&self, w: &World) -> Canvas {
    ...
    let progress = ProgressBar::new(self.hsize as u64 * self.vsize as u64);
...
use crate::{assert_fuzzy_eq, util::FuzzyEq, tuple::Tuple, color::Color};
...
use super::*;
  ...
  fn construct_ray_when_camera_is_transformed() {
    ...
    assert_fuzzy_eq!(Tuple::vector((2.0_f64.sqrt()) / 2.0, 0.0, -((2.0_f64.sqrt()) / 2.0)), r.direction);
  }
  ...
  fn rendering_world_with_camera() {
    ...
    assert_fuzzy_eq!(Color::new(0.38066, 0.47583, 0.2855), img_canvas.pixel_at(5, 5));
  }
}